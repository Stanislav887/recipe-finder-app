...
@Component({
  ...
  imports: [ IonButtons, IonIcon, IonCardSubtitle, RouterLink, IonCard, IonCardHeader, IonCardTitle, IonButton, FormsModule, IonInput, IonHeader, IonToolbar, IonTitle, IonContent],
})
